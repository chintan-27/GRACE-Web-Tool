...
SMTP_FROM  = os.getenv("SMTP_FROM", "noreply@crown-tool.example.com")
# Public frontend URL used in email restore links
FRONTEND_URL = os.getenv("FRONTEND_URL", "http://localhost:3000")
# How long (seconds) a restore token remains valid (default 6 h)
