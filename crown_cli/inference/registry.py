...
MODEL_REGISTRY: Dict[str, Dict[str, Any]] = {
    "grace-native": {
        ...
        "proj_type": "conv", "hf_filename": "grace_native.pth",
    },
    "grace-fs": {
        ...
        "proj_type": "conv", "hf_filename": "grace_fs.pth",
    },
    "domino-native": {
        ...
        "fixed_range": (0, 255), "resize_spatial_size": (176, 256, 256),
        "proj_type": "perceptron", "hf_filename": "domino_native.pth",
    },
    "domino-fs": {
        ...
        "percentile_range": (25, 75), "interpolation_mode": "bilinear",
        "fixed_range": (0, 255), "resize_spatial_size": (256, 256, 256),
        "proj_type": "perceptron", "hf_filename": "domino_fs.pth",
    },
    "dominopp-native": {
        ...
        "percentile_range": (25, 75), "interpolation_mode": "bilinear",
        "fixed_range": (0, 255), "resize_spatial_size": (176, 256, 256),
        "proj_type": "perceptron", "hf_filename": "dominopp_native.pth",
    },
    "dominopp-fs": {
        ...
        "percentile_range": (25, 75), "interpolation_mode": "bilinear",
        "fixed_range": (0, 255), "resize_spatial_size": (256, 256, 256),
        "proj_type": "perceptron", "hf_filename": "dominopp_fs.pth",
    },
}
