...
from monai.transforms import Compose, Spacingd, Orientationd, ScaleIntensityRanged, Resize, ResizeWithPadOrCropd, ResizeWithPadOrCrop
...
def save_predictions(predictions, input_img, output_dir, base_filename):
    ...
    mat_save_path = os.path.join(output_dir, f"{base_filename}_pred_DOMINOPP.mat")
