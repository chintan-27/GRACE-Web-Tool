		...
		<div className="flex flex-col items-center justify-center h-screen">
			...
			<div className="flex flex-row mt-4 space-x-4">
				...
				<label className={`flex items-center ${checkbox2 ? 'text-lime-600' : 'text-gray-500'}`}>
					<input type="checkbox" checked={checkbox2} onChange={() => setCheckbox2(!checkbox2)} className="mr-2 h-5 w-5 text-lime-600 border-gray-300 rounded-sm focus:ring-lime-500" />
					<span className="text-lg font-medium">DOMINO</span>
				</label>
				<label className="flex items-center text-gray-500">
					<input type="checkbox" disabled checked={checkbox3} onChange={() => setCheckbox3(!checkbox3)} className="mr-2 h-5 w-5 text-gray-300 border-gray-300 rounded-sm" />
